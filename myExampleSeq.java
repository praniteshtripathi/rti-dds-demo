...
/**
* A sequence of myExample instances.
*/
public final class myExampleSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public myExampleSeq() {
        super(myExample.class);
    }

    public myExampleSeq (int initialMaximum) {
        super(myExample.class, initialMaximum);
    }

    public myExampleSeq (Collection<?> elements) {
        super(myExample.class, elements);
    }

    public  myExample get(int index) { 
        return (myExample) super.get(index); 
    }
