...
public class myExampleSubscriber {
    // -----------------------------------------------------------------------
    // Public Methods
    // -----------------------------------------------------------------------
    ...
    private static void subscriberMain(int domainId, int sampleCount) {
        ...
        myExampleDataReader reader = null;
        ...
        try {
            ...
            listener = new myExampleListener();

            /* To customize data reader QoS, use
            the configuration file USER_QOS_PROFILES.xml */

            reader = (myExampleDataReader)
            ...
            ++count) {
                System.out.println("myExample subscriber sleeping for "
    ...
    private static class myExampleListener extends DataReaderAdapter {

        myExampleSeq _dataSeq = new myExampleSeq();
        SampleInfoSeq _infoSeq = new SampleInfoSeq();

        public void on_data_available(DataReader reader) {
            myExampleDataReader myExampleReader =
            (myExampleDataReader)reader;

            try {
                myExampleReader.take(
                    _dataSeq, _infoSeq,
                ...
                for(int i = 0; i < _dataSeq.size(); ++i) {
                    ...
                    if (info.valid_data) {
                        System.out.println(
                            ((myExample)_dataSeq.get(i)).toString("Received",0));
                ...
                myExampleReader.return_loan(_dataSeq, _infoSeq);
            }
        }
    }
}
