...
public class myExampleTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "myExample";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final myExampleTypeSupport _singleton
    = new myExampleTypeSupport();
    ...
    */
    public static myExampleTypeSupport get_instance() {
        return _singleton;
    }

    public static myExampleTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return myExampleTypeCode.VALUE;
    }

    @Override
    public Object create_data() {
        return myExample.create();
    }
    ...
    * <code>this</code> is not a <code>myExample</code>
    * type.
    */
    @Override 
    public Object copy_data(Object destination, Object source) {

        myExample typedDst = (myExample) destination;
        myExample typedSrc = (myExample) source;
        ...
        Object sample) 
    {
        ...
        short encapsulation_id = CdrEncapsulation.getEncapsulationFromFinal(
            ...
            ExtensibilityKind.EXTENSIBLE_EXTENSIBILITY);
        boolean xcdr1 = (encapsulation_id <= CdrEncapsulation.CDR_ENCAPSULATION_ID_PL_CDR_LE);
        myExample typedSrc = (myExample) sample;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            myExample typedDst = (myExample) dst;
            typedDst.clear();      
            int DHtmpPosition = 0;
            int DHtmpSize = 0;
            long DHtmpLength = 0;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            myExample typedDst = (myExample) sample;
            deserialize_sample(
    ...
    int mask) {
        return new myExampleDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new myExampleDataReader(native_reader, listener, mask, this);   
    ...
    protected myExampleTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false, myExampleTypeCode.VALUE, myExample.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected myExampleTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport, myExampleTypeCode.VALUE, myExample.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
